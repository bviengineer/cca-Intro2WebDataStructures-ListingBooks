var authorFirstName = document.getElementById("author-first-name"), 
    ...
    //SCOPE OF APPLICATION
        //Once addAuthorButton is clicked, will like to:
            ...
            //3. Loop through array to verify that all authors and book titles are entered
    ...
    //will construct an object with author name & book title
        //aFName, aLName & aBookTitle are parameteres or placeholders for what will be passed to the function when it's called
    var Author = function Author(aFName, aLName, aBookTitle) { 
         this.aFirstName = authorFirstName;
         this.aLastName = authorLastName;
         ...
         return this.authorFirstName + " " + this.authorLastName + "\n" + "Title of Book: " + this.bookTitle;
        }
    }

    //will call on the Author constructor to create new object for each new author,
        //push author information to authorList array & update the array
    ...
    //will add author info to array via push(), loop through the array
        //and update displayDiv by clearing info that's present in preparation
    ...
    var updateArrayList = function updateArrayList() {
        ...
        for(i = 0; i < authorList.length; i++) {
            ...
            displayDiv.innerText += i + ": " + newAuthorInfo.toString() + "\n";
        } 
    }

    //designed to clear <divs> used as display areas and text boxes used for input
        //& will only execute once called
